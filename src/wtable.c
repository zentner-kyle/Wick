...
void * wtable_lookup( wtable * self, void * key ) {
  ...
  #define RETURN_NULL( bucket ) \
    return NULL;
  SELECT_BUCKET( self, key, self->data, RETURN_VAL, RETURN_VAL, RETURN_NULL, RETURN_NULL );
  #undef RETURN_VAL
  #undef RETURN_NULL
}
...
void * wtable_lookup_or_add( wtable * self, void * key, void * (*on_missing)(void * key) ) {
  ...
  SELECT_BUCKET( self, key, self->data, RETURN_FOUND, RETURN_FOUND, ADD_FIRST, ADD_NOT_FIRST );
}
...
void wtable_set( wtable * self, void * key, void * value ) {
  ...
  #define SET( bucket ) \
    (bucket)->value = value;
  SELECT_BUCKET( self, key, self->data, SET, SET, ADD_FIRST, ADD_NOT_FIRST );
  #undef ADD_NOT_FIRST
}
